...
const MainDashboard = () => {
  ...
  const { registerUser: searchUser, data: searchData, loading: searchLoading, error: searchError } = usePostApi(searchUrl);

  const { registerUser: logoutUser, data: logoutData, loading: logoutLoader, error: logoutError } = usePostApi(logoutUrl);
    ...
    <>
      {
        <>
          ...
          <div className="p-16">
            <TableData debouncedValue={debouncedValue.value} searchData={searchData} loggedUser={loggedUser}
